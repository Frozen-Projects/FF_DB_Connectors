...
struct FF_DB_CONNECTORS_API FSQLiteRows
{
...
DECLARE_DYNAMIC_DELEGATE_TwoParams(FDelegateSQLite, bool, bIsSuccessfull, FString, ErrorCode);

UCLASS()
class FF_DB_CONNECTORS_API ASQLite_Manager : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	virtual bool SQLiteOpen(FString DB_Path, ESQLiteOpenType OpenType);
	...
	virtual bool SQLiteWriteValue(FString& ErrorCode, const FString TableName, const FString ColumnName, const FString InValue);
